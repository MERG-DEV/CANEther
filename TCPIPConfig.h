...
#define MY_DEFAULT_HOST_NAME		"CBUS           "
...
#define MY_DEFAULT_MAC_BYTE4            (0x32)	// controller and wish to use the
#define MY_DEFAULT_MAC_BYTE5            (0x65)	// internal factory programmed MAC
#define MY_DEFAULT_MAC_BYTE6            (0x0D)  // address instead.
 ...
 */
	...
	#define TCP_ETH_RAM_SIZE					(4790ul)
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		{
			{TCP_PURPOSE_GENERIC_TCP_CLIENT, TCP_ETH_RAM, 512, 256},
			{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_ETH_RAM, 512, 256},
			{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_ETH_RAM, 512, 256},
			{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_ETH_RAM, 512, 256},
			{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_ETH_RAM, 512, 256},
